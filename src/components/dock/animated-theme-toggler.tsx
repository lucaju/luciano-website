...
export const AnimatedThemeToggler = ({ className, duration = 400, showLabel, ...props }: AnimatedThemeTogglerProps) => {
	...
	return (
		<Button ref={buttonRef} className={cn(className)} onClick={toggleTheme} size="sm" variant="ghost" {...props}>
			{!isClient ? (
