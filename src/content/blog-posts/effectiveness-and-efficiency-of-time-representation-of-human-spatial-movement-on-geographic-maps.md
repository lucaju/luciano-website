...
![Figure 1: Example of the maps uses in the experiment: (A) sparse map using colours, (B) dense map using thickness, and (C) sparse map using both techniques.](../../assets/images/blog/Screen-Shot-2017-12-30-at-6.39.29-PM.png)
...
![Figure 2: Means of response time between different densities maps (errors Bar: 95% CI)](../../assets/images/blog/Screen-Shot-2017-12-30-at-6.45.15-PM.png)

![Figure 3: Means of response time between different encoding techniques (errors Bar: 95% CI)](../../assets/images/blog/Screen-Shot-2017-12-30-at-6.45.23-PM.png)
...
![Figure 4: Means of response time between different encoding techniques in sparse and dense maps (errors Bar: 95% CI)](../../assets/images/blog/Screen-Shot-2017-12-30-at-6.45.33-PM.png)
...
![Figure 5: Means of accuracy rate between different route densities (errors Bar: 95% CI).](../../assets/images/blog/Screen-Shot-2017-12-30-at-6.45.39-PM.png)
Figure 5: Means of accuracy rate between different route densities (errors Bar: 95% CI).

![Figure 6: Means of accuracy rate between different encoding techniques (errors Bar: 95% CI).](../../assets/images/blog/Screen-Shot-2017-12-30-at-6.45.46-PM.png)
...
![Figure 7: Means of accuracy rate between different encoding techniques in sparse and dense maps (errors Bar: 95% CI)](../../assets/images/blog/Screen-Shot-2017-12-30-at-6.46.00-PM.png)
...
Dong, W., Ran, J., & Wang, J. (2012). Effectiveness and Efficiency of Map Symbols for Dynamic Geographic Information Visualization. Cartography and Geographic Information Science, 39(2), 98–106. doi:10.1559/1523040639298
