...
![Figure 1: (A) Nike+ shows the runner performance after the exercise: a map displays the route traveled coloured by the instant speed in each section, while the graph below presents elevation and speed. (B) Runkeeper shows the route traveled after a physical activity. (C) Moves' main screen shows a timeline of user’s daily movement activity.](../../assets/images/blog/Screen-Shot-2017-12-30-at-7.07.21-PM-1200x605.png) Figure 1: (A) Nike+ shows the runner performance after the exercise: a map displays the route traveled coloured by the instant speed in each section, while the graph below presents elevation and speed. (B) Runkeeper shows the route traveled after a physical activity. (C) Moves' main screen shows a timeline of user’s daily movement activity.
...
![Figure 3: When the user selects to encode data by “transportation,” each route is colour coded to reflect the type of transportation used.](../../assets/images/blog/proto2-1200x686.png) Figure 3: When the user selects to encode data by “transportation,” each route is colour coded to reflect the type of transportation used.
