---
title: "Occupy: legitimacy to be on the public space"
coverImage: "./abc_wall_street_protesters_aerial_nt_111005_wg1-e1381544120920.jpg"
coverAlt: "Occupy Wall Street"
description: "Examining the Occupy movement's challenge to public space legitimacy and the contrasting government responses to different forms of public assembly. This reflection questions why some gatherings are protected while others face suppression, revealing deeper truths about power and protest in modern society"
...
Since 2011 a series of protests against the schizophrenic logic of capitalism has been occurring around the world. The even has they own brand name: Occupy. The main idea is to occupy public places, mainly squares and plazas, in order "speak" with the governs and the economic power. It starts in New York with the **Occupy Wall Street** (**OWS**) on September 17, 2011, in [Zuccotti Park](http://en.wikipedia.org/wiki/Zuccotti_Park "Zuccotti Park"), located in [New York City's](http://en.wikipedia.org/wiki/New_York_City "New York City") [Wall Street](http://en.wikipedia.org/wiki/Wall_Street "Wall Street") financial district and quickly spread out to other places in the States and the world.
