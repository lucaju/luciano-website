...
coverImage: "./workflow_orlando_v4.jpg"
coverAlt: "Workflow Interface for Editorial Process"
...
![Figure 1: First version of structured surface editorial workflow uses D3.js to build the interface.](./Milena-workflow-surface-v03b.png "Workflow for Editorial Process - First Sketch") Figure 1: First version of structured surface editorial workflow uses D3.js to build the interface.
...
![Figure 2: Orlando Workflow is the second version of a structured surface workflow.](./workflow_orlando_v4.jpg "Orlando Workflow") Figure 2: Orlando Workflow is the second version of a structured surface workflow.
...
![Figure 3: Connection between Voyant and workflows could help users identify issues during the editorial process.](./workflow_TextAnalisys_wordcloud.jpg "Workflow Future Directions - Text Analysis - word cloud") Figure 3: Connection between Voyant and workflows could help users identify issues during the editorial process.
...
![Figure 4: Stage’s dependency is a fundamental feature to control information through the workflow.](./workflow_orlando_dependency.jpg "Orlando Workflow Dependencies") Figure 4: Stage’s dependency is a fundamental feature to control information through the workflow.
...
![Figure 5: Sketch showing how to deal with workflow authoring and customization.](./workflow_buildMode.jpg "Workflow futur directions - Build Mode") Figure 5: Sketch showing how to deal with workflow authoring and customization.
...
![Figure 6: Sharing feature could improve collaborative work by informing work progress.](./workflow_share.jpg "Workflow Future Directions - Shared Workflows") Figure 6: Sharing feature could improve collaborative work by informing work progress.
...
![Figure 7: Multi-touch devices could help the project manager to keep workflows update.](./ipad.jpg "Orlando Workflow - iPad version") Figure 7: Multi-touch devices could help the project manager to keep workflows update.
