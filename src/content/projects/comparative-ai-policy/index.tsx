...
import image from './us-public-consultation-ai-copyright-netvis-mentions.png';

const imageAlt = 'Comparative AI Policy and Regulation';

export const comparative_ai_policy_and_regulation: ProjectSchema = {
	...
	extra: [
		<Collection key="publications" label="Publications">
			<Item type="Journal Article" pending>
				Frizzera, L., & McKelvey, F. [In Review].{' '}
				<strong>AI Lobbying and the Future of Canadian Copyright</strong>. Canadian Journal of Communication.
				Special TechLobby edition.
			</Item>
			<Item url="https://doi.org/10.1080/1369118X.2025.2565328" type="Journal Article">
				McKelvey, F., Simon, B., & Frizzera, L. (2025).{' '}
				<strong>Generative AI and the Information Commons: Controversy, Copyright, and Closure</strong>.
		...
		<Collection key="conferences" label="Conferences">
			...
			<Item type="Conference Paper">
				Frizzera, L. & McKelvey, F. (2025). <strong>AI Lobbying and the Future of Canadian Copyright</strong>.
				In the panel “The Tech Lobby: Big Tech Companies and Canadian Communications and Digital Media Policy.”
			...
			<Item type="Conference Paper">
				...
				<strong>Generative AI and the Information Commons: Controversy, Copyright, and Closure</strong>.
				Association of Internet Researchers (AoIR). Sheffield University. Sheffield, UK. Oct 30 - Nov 2, 2024.
			</Item>
		</Collection>,
	],
	content: (
		<div className="space-y-1.5">
			...
			<Text>
				This research examines AI policy and regulation across Canada, the United States, and Brazil. I am
				investigating how these countries structure public consultation processes, legislative debates, and
				stakeholder engagement in AI governance. Using a mixed-methods approach that combines policy document
				analysis, discourse analysis, and stakeholder mapping, my objective is to identify key policy actors and
				analyze their lobbying strategies, coalition-building efforts, and framing techniques.
			</Text>
			<Text>
				While all three countries share concerns about algorithmic bias, privacy protection, and democratic
				accountability, they have distinct national approaches shaped by different political cultures: Canada
				emphasizes human rights and a risk management approach, the US focuses on technological leadership and
				national security, and Brazil prioritizes digital inclusion and data sovereignty.
			</Text>
