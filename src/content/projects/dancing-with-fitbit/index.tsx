...
export const dancingWithFitbit: ProjectSchema = {
	...
	content: (
		<div className="space-y-1.5">
			...
			<Text>
				Florence, a choreographer and dance professor in her late fifties, tracked her activity for one week
				using a Fitbit Charge HR watch. Throughout this period, she took notes on her experience and the
				thoughts that emerged from it in a journal. After the week of tracking, she created and performed a
				choreography inspired by this lived experience. The data collected by the self-tracking device were then
				used to create a soundtrack and produce visual effects. These two “re-workings” of the Fitbit data were
				integrated into an edited video and used to make this web-based interactive platform. This research and
				creation project aimed to explore how data and the lived experience of self-tracking could be used to
				generate subversive forms of data materialization through choreography, sound, and visuals. We aimed to
				critique injunctions related to aging bodies and the normativity of “successful aging.”
			</Text>
			<Text>
				...
				“bio” metric bodies produced by Fitbit, to deconstruct the narratives and temporalities embedded in and
