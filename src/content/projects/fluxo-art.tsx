	...
	content: (
		<div className="space-y-1.5">
			...
			<Text>
				...
				web developer, but I was also involved in many aspects of a start-up company, from managerial decisions to the
				conceptualization of the material we produced. I have produced several visual communication pieces for different
