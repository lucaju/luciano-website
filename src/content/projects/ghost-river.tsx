...
export const ghostRiver: TimelineEntry = {
	...
	content: (
		<div className="space-y-1.5">
			...
			<Text>
				Using historical-geographical materialism methodologies, an ethnographic inquiry into human, non-human and
				...
				incremental destruction of sustaining habitats. Through the creation of a counter map and ethnography of the
				river and water infrastructure, we will contest the homogenization of the space as it represented in zoning
				regulations, land-use maps, and property regimes to offer new means of expressing hydro-social relationships in
				place.
			</Text>
		</div>
	),
