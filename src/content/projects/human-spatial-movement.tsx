...
export const humanSpatialMovement: TimelineEntry = {
	...
	content: (
		<div className="space-y-1.5">
			...
			<Text>
				As an inherent human condition, mobility brings together communicative, technological, geographical, economic,
				cultural, and social forces that transform the surrounding space. In fact, space only becomes social meaningful
				through human agency and activities, such as walking and the desire to move in one or another direction. As we
				walk, we always leave some sort of traces behind, which could be both immaterial, like nostalgia or desire, and
				concrete, such as built environment, and marks on the sand.
			</Text>
			<Text>
				All these moments and traces are transitory (space) and temporary (time), which makes difficult to understand
				and analyze their nature and rules. Yet, if we follow our trails we might be able to understand our interactions
				with the surrounding environment and with other people; we even might be able to grasp the patterns and rules
				that govern our movements.
			</Text>
			<Text>
				Human Spatial Movement is an interactive visualization that enables you to discover your mobility pattern
				through time and space. It shows all your Moves data into a map while you can filter by date and type of
				transportation, and encode information by type of transportation and duration. You can uncover your digital
				traces to learn about your mobility preferences in everyday life.
			</Text>
			<Text>
				This project was developed as a project for my course in Knowledge Visualization and Communication at the SIAT
				Ph.D. program.
			</Text>
		</div>
	),
