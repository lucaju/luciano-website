import leafWriterImage from '@/assets/images/projects/leaf-writer.png'
...
export const leafWriter: TimelineEntry = {
	title: 'LEAF-Writer',
	...
	extra: [
		...
		<Collection label='Conferences'>
			<Item type='Exhibition' pending>
				Cummings, J., Jakacki, D., Brown, S., Ilovan, M., Frizzera, L., Rubin-Detlev, K.
				(Submitted).
				<strong>
					Implementing TEI Authority File Lookups in LEAF-Writer: Researcher-centric software
					development in precarious funding contexts
				</strong>
			...
			<Item type='Conference Paper'>
				...
				<strong>
					Linking Your *-ographies: Developing project-specific TEI Authority File Lookups for
					LEAF-Writer
				</strong>
			...
			<Item type='Conference Paper'>
				...
				<strong>TEI Semantic Encoding with LEAF-Writer</strong>. Canadian Society for Digital
				Humanities (CSDH) @ Congress 2024. McGill University. Montreal, Canada.
			</Item>
		</Collection>,
	...
	content: (
		<div className='space-y-1.5'>
			...
			<Text>
				LEAF-Writer is an in-browser text markup editor and Web Annotation tool provided as part of
				the Linked Editing Academic Framework (
				<a
				...
				) tool suite. LEAF-Writer has been designed to provide an accessible and easy-to-use on-ramp
				to text encoding for pedagogical and research purposes. It furthers the dissemination,
				adoption, and engaged use of the TEI Guidelines, especially for those who lack local
				infrastructure or technical support.
			</Text>
			<Text>
				LEAF-Writer is developed through a partnership among research institutions in Canada, the
				US, and the UK, funded by the Social Sciences and Humanities Research Council (
				<a
					className='hover:underline'
			...
			<Text>
				LEAF-Writer was build upon a previou iteration of CWRC-Writer, the XML & RDF online editor
				of the Canadian Women Research Collaboratory (
				<a
					className='hover:underline'
					href='https://cwrc.ca/'
					rel='noopener noreferrer'
