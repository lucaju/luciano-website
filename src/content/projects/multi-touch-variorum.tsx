	...
	extra: [
		<Collection key="publications" label="Publications">
			<Item type="Journal Article" url="http://dh2013.unl.edu/abstracts/ab-318.html">
				Frizzera, L., Vela, S., Sondheim, D., Michura, P., Ilovan, M., Rockwell, G., Ruecker, S., & the INKE TEAM.
				(2013). <strong>Designing for Multitouch Surfaces as Social Reading Environments</strong>. 35–37.
			</Item>
		</Collection>,
		<Collection key="conferences" label="Conferences">
			<Item type="Conference Paper">
				Frizzera, L., Vela, S., Sondheim, D., Michura, P., Ilovan, M., Rockwell, G., Ruecker, S., & INKE TEAM. (2013).{' '}
				<strong>Designing for Multitouch Surfaces as Social Reading Environments</strong>. Presented in the panel “The
				Design of New Knowledge Environments.” Digital Humanities 2013. University of Nebraska. Lincoln, USA.
			</Item>
		</Collection>,
	...
	content: (
		<div className="space-y-1.5">
			<Text>
				...
				literary works, such as Shakespeare’s variorum editions. The interface was designed for use on a multi-touch
				table that can accommodate up to four researchers standing around its edges, allowing them to tap, flick, and
				rotate through different editions of texts using natural gestures. The development process required a complete
				rethink of digital interface design. The initial version unconsciously followed desktop conventions with fixed
				orientations and static panels. Early tests revealed the need for a fundamental redesign to support
				collaborative interaction from different sides of the device.
			</Text>
			<Lightbox
				images={[
			...
			<Text>
				Creating a genuinely “social” reading interface proved more challenging than simply enlarging a touchscreen. We
				had to solve practical problems, such as making reading panels movable and rotatable for each user, while
				implementing a lock function to distinguish between gestures meant to move panels and interact with text.
				Furthermore, we grappled with defining what “social” means in a humanities context, ultimately developing two
				distinct interface approaches: a “Lazy Susan” design with a central rotating ring of shared editions that
				encourages conversation around a shared digital workspace.
			</Text>
			<iframe
