	...
	content: (
		<div className="space-y-1.5">
			...
			<Text>
				...
				(LOD) to find and match entities entities in a document. NERVE suggests relevant Uniform Resource Identifiers
				(URIs) for entities, so users can match entities to an authority in order to turn it into LOD.
			</Text>
			<Text>
