...
export const pictio: TimelineEntry = {
	...
	content: (
		<div className="space-y-1.5">
			...
			/>
			<Text>
				The field of Artificial Intelligence regularly establishes a relationship of competition between humans and
				machines, which leads to the avoidance of mistakes. This research considers the creation of a collaborative and
				“mistake-friendly” drawing game for humans and machines. The game PICT.IO is inspired by the popular game{' '}
				<i>Pictionary</i>, a widely played drawing game in which one person receives a written message and must convey
				it to their team using drawings.
			</Text>
			<Text>
			...
			<Text>
				...
				by two teams. Each team is composed of two humans and one machine. The goal of the game is making the team's
