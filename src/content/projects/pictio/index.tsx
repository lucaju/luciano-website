	...
	extra: [
		...
		<Collection key="conferences" label="Conferences">
			<Item type="Conference Paper">
				...
				<strong>PICT.IO: Developing a Collaborative Game for Humans and Machines</strong>. Canadian Games
				Studies Association (CGSA) @ Congress 2019. UBC. Vancouver, Canada.
			</Item>
			<Item type="Conference Paper">
				Salles, J., Frizzera, L., & Zamboni, J. (2018).{' '}
				<strong>Pict.io: A Human-Machine Collaborative Game</strong>. Camp Serrapilheira. Rio de Janeiro,
				Brazil.
			</Item>
		</Collection>,
		<Collection key="symposia" label="Symposia">
			<Item type="Guest Speaker">
				...
				<strong>Pict.io: A Human-Machine Collaborative Game</strong>. Conversation Cytoenne our l’IA. Montreal,
				Canada.
			</Item>
		</Collection>,
		<Collection key="exhibitions" label="Exhibitions">
			...
			<Item type="Exhibition">
				Québec Numérique. (April 6-7, 2019). Musée de la Civilisation de la ville de Québec. Quebec City,
				Canada.
			</Item>
			...
			<Item type="Exhibition">
				Camp Serrapilheira de divulgação científica (4-7 de setembro de 2018), Museu do Amanhã, Rio de Janeiro,
				Brasil.
			</Item>
			<Item type="Exhibition">
	...
	content: (
		<div className="space-y-1.5">
			...
			<Text>
				...
				, which uses machine learning to guess what players are drawing. In PICT.IO, each team consists of two
				humans and one machine, collaborating and communicating with limited resources, using drawings or speech
				to solve visual challenges.
			</Text>
			<Text>
