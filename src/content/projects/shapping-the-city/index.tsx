...
import shapingCity1 from './shaping1.png';
import shapingCity2 from './shaping2.png';
import shapingCity3 from './shaping3.png';

const altText = 'Shaping the City';

export const shapingTheCity: ProjectSchema = {
	title: 'Shaping the City',
	place: 'Machine Agencies',
	date: { start: '2012-09-01', end: '2013-08-30' },
