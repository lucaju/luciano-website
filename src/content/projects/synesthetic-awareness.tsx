...
export const synestheticAwareness: TimelineEntry = {
	...
	content: (
		<div className='space-y-1.5'>
			...
			<Text>
				This project proposes a synesthetic experiment in which data collected by the city will be
				translated to a human sensorial input. It uses a mobile application to retrieve information
				about air quality in Montreal to produce data-driven audio and visual feedback.
			</Text>
		</div>
	),
}
