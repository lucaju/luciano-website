	...
	content: (
		<div className="space-y-1.5">
			...
			<Text>
				...
				mention at least one of the two selected keywords. Each tweet is represented by a color-coded square. An
				animation representing the flowing tweets reconstruct the timeline. The content of a tweet can be seen by mouse
				over on a square, showing the text and the user avatar on Twitter. There is an option to reorder the tweets by
				keywords. Since Twitter close their API and created strict rules for accesses, this prototype stopped working.
				But you can still see some screenshots.
			</Text>
		</div>
	),
};
