	...
	extra: [
		<Collection key="publications" label="Publications">
			<Item type="Journal Article" url="https://doi.org/10.1093/llc/fqt053">
				Frizzera, L., Radzikowska, M., Roeder, G., Pena, E., Dobson, T., Rockwell, G., Ruecker, S. The INKE
				Research Group. (2013). <strong>Visual Workflow Interfaces for Editorial Processes</strong>. Literary
				and Linguistic Computing, 28(3), 26.
			</Item>
			<Item
				type="Proceedings"
				url="http://www.dh2012.uni-hamburg.de/conference/programme/abstracts/workflows-as-structured-surfaces/"
			>
				Frizzera, L., Ruecker, S., Radzikowska, M., Rockwell, G., Brown, S., & INKE TEAM. (2012). Workflow as
				Structured Surfaces. 324–326.
			</Item>
		</Collection>,
		<Collection key="conferences" label="Conferences">
			<Item type="Conference Paper">
				Frizzera, L., Montague, J., Sperhacke, S., Bernardes, M., Rockwell, G., Ruecker, S. & INKE Research
				Group (2014). <strong>Structured Surfaces for Digital Board Games: The DH Experience</strong>. Presented
				in the panel “The lifecycle of the interface.” Canadian Society for Digital Humanities (CSDH) @ Congress
				2014. Brock University. St. Catherine, Canada.
			</Item>
			<Item type="Conference Paper">
				Mohseni, A., Sondheim, D., Frizzera, L., Rockwell, G., & INKE TEAM. (2013).{' '}
				<strong>The Tablet as a New Medium for Scholarly Editions</strong>. Presented in the panel “The Design
				of New Knowledge Environments.” Digital Humanities 2013. University of Nebraska. Lincoln, USA.
			</Item>
			<Item type="Conference Paper">
				Li, T., Frizzera, L., Radzikowska, M., Ruecker, S., & INKE TEAM. (2013).{' '}
				<strong>Tangible Workflows: Feeling the flow of information</strong>. Presented in the panel “‘Touch-a
			...
			<Item type="Conference Paper">
				Frizzera, L., Ruecker, S., Radzikowska, M., Rockwell, G., Brown, S., & INKE TEAM. (2012).{' '}
				<strong>Workflow Interface for Editorial Process</strong>. Presented in the panel “Interface to
				Interface Research” at the SDH-SEMI @ Congress 2012. University of Waterloo. Waterloo, Canada.
			</Item>
		</Collection>,
