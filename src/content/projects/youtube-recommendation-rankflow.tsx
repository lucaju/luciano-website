...
export const youtubeRecommendationRankflow: TimelineEntry = {
	...
	content: (
		<div className="space-y-1.5">
			...
			<Text>
				What videos does YouTube recommend when serching for party leaders during elections party? an analytical tool
				that examines YouTube’s recommendation systems, influencer culture, and the creative economy
			</Text>
			<Text>
				The study sought to investigate how the YouTube platform operates, focusing on algorithmic activity and the
				strategies employed by both human and automated (robot) actors within federal and regional elections. The aim
				was to understand the impact of this system of mediation on society and to demystify preconceptions about
				ideologically neutral technologies in highly disputed political events. The research focuses on three case
				studies: 1) the 2018 Ontario (Canada) election, 2) the 2018 Quebec (Canada) election, and 3) the 2018 Brazilian
				Federal Election. The data collection was carried out during the 2018 campaign periods in Ontario (May and
				June), Quebec (Auguest and September) and in Brazil (August and October).
			</Text>
			<Text>
			...
			<Text>
				The rankflow allows the analysis of the evolution of each video in the rank, find trends, and observe what has
				been recommended. This might give us some insights about how YouTube rank system works, what are the most
				prominent videos on specific topics, and what narrative this rank bring to the political debate in Canada.
			</Text>
			<SubHeading>Youtube Recommendation Scraper</SubHeading>
			<Text>
				As a way to make the data collection process easier and more efficient, we designed a web application with a
				ease-to-use UI to allow others researchers to collect data from YouTube's recommendation system. Due to funding
				restriction the project was paused, but the code is available on GitHub.
			</Text>
		</div>
	),
};
